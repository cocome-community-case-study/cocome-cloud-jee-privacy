/**
 */
package org.palladiosimulator.pcm.core.compositionprivacy.util;
...
import org.palladiosimulator.pcm.core.compositionprivacy.*;
...
public class CompositionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CompositionPackage.ASSEMBLY_CONNECTOR_PRIVACY: {
